...
class InvoiceHandler:
    ...
    def _create_invoice_row(self, row_index: int, amount: str, start_date: str, end_date: str, main_transaction_id: str, sub_transaction_id: str, name_person: str, payment_recipient_identifier: str, service_recipient_identifier: str, business_partner_id: str) -> None:
        """
    ...
    def create_invoice(
        ...
        self._create_invoice_row(0, main_transaction_amount, start_date, end_date, main_transaction_id, sub_transaction_id, name_person, payment_recipient_identifier, service_recipient_identifier, business_partner_id)

        # Insert new line
        self.session.findById("wnd[0]/usr/btnINDSAETTXTBTN").press()

        # Sub administration fee row
        self._create_invoice_row(1, sub_transaction_fee_adm_amount, start_date, end_date, main_transaction_id, sub_transaction_fee_adm_id, name_person, payment_recipient_identifier, service_recipient_identifier, business_partner_id)

        # Insert new line
        self.session.findById("wnd[0]/usr/btnINDSAETTXTBTN").press()

        # Sub institution fee row
        self._create_invoice_row(2, sub_transaction_fee_inst_amount, start_date, end_date, main_transaction_id, sub_transaction_fee_inst_id, name_person, payment_recipient_identifier, service_recipient_identifier, business_partner_id)
